...
$sql="SELECT id_proyecto,id_entidad,nume_regis,ano,titulo,id_sector,id_clasificacion,resumen,fecha_regi,estado,tipo,id_dnp,tipopo,terminos,contacto FROM proyectos WHERE id_proyecto=$id_proyecto";
$rs=$mysqli->query($sql);
$dts = $rs->fetch_assoc();
...
<div class="container text-center col-lg-12">
      <div class="col-md-1">
        ...
        <div class="col-md-10">
          ...
          <div class="panel-heading">Modificar Proyectos</div>
            <div class="panel-body">
            <form class="form-signin" name="form1" action="mod_proy.php" method="post">
            ...
            <input type="text" name="ptitulo" id="ptitulo" value="<?php echo $dts['titulo']; ?>" class="form-control" placeholder="" required >
            <label for="nit">* Fecha:</label>
            <input type="text" name="pfecha" id="pfecha" value="<?php echo $dts['fecha_regi']; ?>" class="form-control" placeholder="" required autofocus>
            <label for="nit">* Año:</label>
            <input type="text" name="pano" id="pano" value="<?php echo $dts['ano']; ?>" class="form-control" placeholder="" required autofocus>
            <label for="nit">* N° Registro:</label>
            <input type="text" name="nume_regis" id="nume_regis" value="<?php echo $dts['nume_regis']; ?>" class="form-control" placeholder="" required autofocus>
            <label for="nit" id="nid_dnp">* Codigo DNP:</label>
            <input type="text" name="id_dnp" id="id_dnp" value="<?php echo $dts['id_dnp']; ?>" class="form-control" placeholder="" >  
...
4rdx            </select>    
            ...
            while($datos = $rs2->fetch_assoc())
              {
                ...
                if($datos['id_sector']==$dts['id_sector'])
            ...
            <textarea name="resumen" id="resumen" class="form-control" rows="10" required><?php echo $dts['resumen']; ?></textarea> 
...
if(isset($_POST['boton']))
{
  ...
  ?>
      ...
      alert('Se ha modificado un nuevo proyecto exitosamente');
      </script>
